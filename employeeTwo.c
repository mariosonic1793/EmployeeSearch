...
{ 
    return * (double *) targetPtr != tableValuePtr->salary;//const void *targetPtr ==> typecast as double pointer then pass into strcmp() 
} 
...
PtrToEmployee searchEmployeeByName(PtrToConstEmployee ptr, int size, double salary) 
{ 
